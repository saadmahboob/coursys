    ...
    with django.db.transaction.atomic():
        ...
        if request.user.is_authenticated():
            ...
            if loggedin_user is None:
                return ForbiddenResponse(request, "The userid '%s' isn't known to this system. If this is a 'role' account, please log in under your primary SFU userid. Otherwise, please contact coursys-help@sfu.ca for assistance." % (request.user.username))
